...
/**
 * @author songtao
 * @create 2020-04-2020/4/9-22:32
 */
public class StTomcat {

    private int port = 8080;
    private ServerSocket server;
    private Map<String,StServlet> servletMapping = new HashMap<String,StServlet>();
        ...
        try{
            ...
            for (Object k : webxml.keySet()) {
                ...
                if(key.endsWith(".url")){
                    ...
                    //单实例，多线程
                    StServlet obj = (StServlet)Class.forName(className).newInstance();
    ...
    private void process(Socket client) throws Exception {
        ...
        StRequest request = new StRequest(is);
        StResponse response = new StResponse(os);
